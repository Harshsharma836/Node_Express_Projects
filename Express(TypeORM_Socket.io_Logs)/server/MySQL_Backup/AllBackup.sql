...
--
-- Dumping data for table `custom_migration_table`
--

LOCK TABLES `custom_migration_table` WRITE;
/*!40000 ALTER TABLE `custom_migration_table` DISABLE KEYS */;
/*!40000 ALTER TABLE `custom_migration_table` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-11-20  7:18:07
